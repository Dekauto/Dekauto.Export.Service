...
{
    /// <summary>
    /// Модель для наполнения данными, требуемыми при заполнении приложения диплома в экспорте. Считывается здесь, из импорта.
    /// </summary>
    public class DiplomaSupplementData
    {
        ...
        /// <summary>Наименование ОПОП для листа «4 доп.сведения», ячейка B6.</summary>
        public string? SupplementAdditionalSheetOpopName { get; set; }

        /// <summary>Строка для B7 листа «4 доп.сведения»: «Форма обучения: …».</summary>
        public string? SupplementAdditionalSheetStudyFormLine { get; set; }

        /// <summary>Квалификация для листа «1 Обладатель диплома» B11; карточка «ОбщСведения» ~C110.</summary>
